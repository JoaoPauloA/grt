const questions = [
    ...
    {
      "question": "O cliente não conseguiu identificar o botão para editar a foto de perfil.",
      "answers": [
        "Teste de Usabilidade",
        "Teste de Aceitação"
      ],
    ...
    {
      "question": "O usuário deve conseguir realizar o upload de 1TB de fotos e a aplicação deve fazer isso em 20 segundos.",
      "answers": [
        "Teste de Desempenho",
        "Teste de Funcionalidade"
      ],
    ...
    {
      "question": "Ao inserir um cartão no caixa eletrônico, o sistema indicou como cartão roubado e permitiu o saque.",
      "answers": [
        "Teste de Segurança",
        "Teste de Funcionalidade"
      ],
    ...
    {
      "question": "O elevado uso do sistema altera o tempo de resposta do servidor para um valor maior especificado.",
      "answers": [
        "Teste de Desempenho",
        "Teste de Estresse"
      ],
